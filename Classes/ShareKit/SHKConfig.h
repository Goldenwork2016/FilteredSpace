...
#define SHKMyAppName			@"FilteredSpace"
#define SHKMyAppURL				@"http://www.filteredspace.com"
...
#define SHKFacebookKey				@"172555996130352"
#define SHKFacebookSecret			@"d1914d63d021bf9fa5f7fb07f2230c19"
 ...
 */
#define SHKTwitterConsumerKey		@"PtSCwDxpdGtmeulLJtKXyQ"
#define SHKTwitterSecret			@"dpveWhAL382EWpfh2qewlls62KrHnXQnAizZYkLPlw"
#define SHKTwitterCallbackUrl		@"www.filteredspace.com/callback" // You need to set this if using OAuth, see note above (xAuth users can skip it)
